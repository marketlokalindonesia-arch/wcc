...
$query = "SELECT o.*, u.first_name, u.last_name FROM orders o 
          ...
          WHERE o.status = 'processing' ORDER BY o.created_at DESC";
...
<head>
    ...
    <title>Processing Orders - WC Clone</title>
...
<body>
    ...
    <div class="main-content">
        <h2 class="mb-4"><i class="fas fa-spinner me-2 text-info"></i>Processing Orders</h2>
